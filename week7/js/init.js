...
function addMarker(data){
    if(data['Do you visit this restaurant frequently?'] == "Yes"){
    L.circleMarker([data.lat,data.lng]).addTo(map).bindPopup(`<h2>${data['What is your favourite restaurant in LA? ']}</h2> <h3>${data['What is your favourite dish from there? ']}</h3> <h4>frequent diner ✅</4>`)
